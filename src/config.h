...
static const struct x11fs_file x11fs_files[] = {
	...
	F( "/root/geometry/size",    READONLY,  false, root_size_read,       NULL                  )
	D( "/0x*"                                                                                  )
	D( "/0x*/border"                                                                           )
	...
	F( "/0x*/geometry/size",     READWRITE, false, geometry_size_read,   geometry_size_write   )
	...
	F( "/0x*/geometry/position", READWRITE, false, geometry_pos_read,    geometry_pos_write    )
	F( "/0x*/geometry/all",      READWRITE, false, geometry_all_read,    geometry_all_write    )
